...
const APPLICATIONS: Application[] = [
  { id: "ЗАЯ-001", name: "Иванов Алексей Петрович", object: "Объект А-12", status: "pending", validUntil: "30.06.2026", position: "Электромонтажник", passType: "QR", submittedAt: "18.04.2026" },
  { id: "ЗАЯ-002", name: "Смирнова Анна Владимировна", object: "Объект Б-7", status: "active", validUntil: "15.07.2026", position: "Инженер ПТО", passType: "Карта", submittedAt: "10.04.2026" },
  { id: "ЗАЯ-003", name: "Козлов Дмитрий Сергеевич", object: "Объект А-12", status: "rejected", validUntil: "—", position: "Сварщик", passType: "QR", submittedAt: "15.04.2026" },
  { id: "ЗАЯ-004", name: "Новикова Елена Игоревна", object: "Объект В-3", status: "pending", validUntil: "01.08.2026", position: "Прораб", passType: "Карта", submittedAt: "20.04.2026" },
  { id: "ЗАЯ-005", name: "Фёдоров Павел Олегович", object: "Объект Б-7", status: "active", validUntil: "20.05.2026", position: "Монтажник", passType: "QR", submittedAt: "01.04.2026" },
  { id: "ЗАЯ-006", name: "Орлова Марина Дмитриевна", object: "Объект Г-1", status: "expired", validUntil: "01.04.2026", position: "Бухгалтер", passType: "Карта", submittedAt: "10.03.2026" },
];

const JOURNAL: JournalEntry[] = [
  { id: "1", name: "Иванов Алексей Петрович", object: "Объект А-12", date: "22.04.2026", entryTime: "07:45", exitTime: "18:30", passType: "QR" },
  { id: "2", name: "Смирнова Анна Владимировна", object: "Объект Б-7", date: "22.04.2026", entryTime: "08:01", exitTime: "17:55", passType: "Карта" },
  { id: "3", name: "Фёдоров Павел Олегович", object: "Объект Б-7", date: "22.04.2026", entryTime: "07:58", exitTime: "18:10", passType: "QR" },
  { id: "4", name: "Козлов Дмитрий Сергеевич", object: "Объект А-12", date: "21.04.2026", entryTime: "08:15", exitTime: "17:40", passType: "QR" },
  { id: "5", name: "Новикова Елена Игоревна", object: "Объект В-3", date: "21.04.2026", entryTime: "08:00", exitTime: "18:00", passType: "Карта" },
  { id: "6", name: "Орлова Марина Дмитриевна", object: "Объект Г-1", date: "20.04.2026", entryTime: "09:00", exitTime: "16:30", passType: "Карта" },
];
